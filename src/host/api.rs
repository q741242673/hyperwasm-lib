//! hwe VM host functions.

pub mod error {
    #[link(wasm_import_module = "hwe::error")]
    extern "C" {
...
pub mod message {
    #[link(wasm_import_module = "hwe::message")]
    extern "C" {
...
pub mod timer {
    #[link(wasm_import_module = "hwe::timer")]
    extern "C" {
...
pub mod networking {
    #[link(wasm_import_module = "hwe::networking")]
    extern "C" {
...
pub mod process {
    #[link(wasm_import_module = "hwe::process")]
    extern "C" {
        ...
        pub fn config_set_name(config_id: u64, name: *const u8, name_len: usize);
        pub fn config_set_expected_time(config_id: u64, time: u64);
        pub fn config_set_relative_ddl(config_id: u64, time: u64);
        pub fn spawn(
            link: i64,
            config_id: i64,
            module_id: i64,
...
pub mod registry {
    #[link(wasm_import_module = "hwe::registry")]
    extern "C" {
...
pub mod wasi {
    #[link(wasm_import_module = "hwe::wasi")]
    extern "C" {
...
pub mod distributed {
    #[link(wasm_import_module = "hwe::distributed")]
    extern "C" {
...
pub mod version {
    #[link(wasm_import_module = "hwe::version")]
    extern "C" {
        pub fn major() -> u32;
        pub fn minor() -> u32;
        pub fn patch() -> u32;
